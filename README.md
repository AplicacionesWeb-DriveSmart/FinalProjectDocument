...
|---------------------|---------------------|--------------|
| Participa en equipos multidisciplinarios con eficacia, eficiencia y objetividad, en el marco de un proyecto en soluciones de ingeniería de software. | <p>Altamirano Saenz, Jorge Armando</p> <p>TB1: Participé en la toma de decisión del tema sobre el proyecto, también discutimos sobre cuáles serían las funcionalidades que tendríamos que implementar en esta plataforma.</p> <p>TP1: Comunicaba a mis compañeros de equipo toda implementación que hacía, debido a que algunas secciones dependen de otras y así evitar cualquier problema.</p> <p>TB2: Me encargué de hacer sesiones con nuestro equipo para poder definir los endpoints que íbamos a usar en el trabajo y cuales serían los métodos CRUDs que íbamos a implementar.</p> <p>TF1: Trabajé en la implementación de estos servicios ya teniendo claro los endpoints y las operaciones CRUDs que íbamos hacer, esto me facilitó el desarrollo ya que tenía ya en mente cuáles eran las operaciones que se requieren para el trabajo.</p> <p>De la Piedra Quintanilla, Erwin Miquel</p> <p>TB1: Colaboré para definir los requisitos del sistema. Esta colaboración aseguró que todas las perspectivas fueran integradas de manera clara y comprensible.</p> <p>TP1: Asumí el rol de coordinador de proyecto, organizando reuniones semanales y utilizando herramientas para asignar tareas y monitorear el progreso. Esto permitió al equipo mantener el ritmo y cumplir con los plazos establecidos.</p> <p>TB2: Participé activamente en sesiones de revisión y retrospectivas para identificar áreas de mejora y ajustar las estrategias según fuera necesario. Este enfoque fomentó un ambiente de mejora continua dentro del equipo.</p> <p>TF1: Trabajé en la integración de soluciones técnicas y de diseño, asegurando que el producto final cumpliera con los estándares de calidad y los objetivos del proyecto. Esto demostró mi capacidad para actuar con eficacia, eficiencia y objetividad en un equipo multidisciplinario.</p> <p>Guimaraes Escalante, Carlos Eduardo</p> <p>TB1: Participé en la elección del tema del proyecto que íbamos a trabajar y aporté en las funcionalidades y requisitos que deberían ser implementadas en la plataforma.</p> <p>TP1: Comuniqué a mis demás compañeros de equipo todos los cambios que implementaba en el proyecto, con el fin de evitar cualquier conflicto.</p> <p>TB2: Participé en las reuniones de corrección del proyecto junto con los demás miembros de mi equipo y esto permitió realizar las respectivas correcciones.</p> <p>TF1: Trabajé en las últimas implementaciones que faltaban para la parte de los endpoints, y comuniqué al equipo las correcciones e implementaciones que realicé.</p> <p>Gutierrez Zumaeta, Manuel Alonso</p> <p>TB1: Participé en la toma de decisión del tema sobre el proyecto, también discutimos sobre cuáles serían las funcionalidades que tendríamos que implementar en esta plataforma.</p> <p>TP1: Comunicaba a mis compañeros de equipo toda implementación que hacía, debido a que algunas secciones dependen de otras y así evitar cualquier problema.</p> <p>TB2: Me encargué de hacer sesiones con nuestro equipo para poder definir los endpoints que íbamos a usar en el trabajo y cuales serían los métodos CRUDs que íbamos a implementar.</p> <p>TF1: Trabajé en la implementación de estos servicios ya teniendo claro los endpoints y las operaciones CRUDs que íbamos hacer, esto me facilitó el desarrollo ya que tenía ya en mente cuáles eran las operaciones que se requieren para el trabajo.</p> <p>Montes Figueroa, Juan Eduardo</p> <p>TB1: Participé en la decisión del tema del proyecto y colaboré en la discusión sobre las funcionalidades que la plataforma debía incluir.</p> <p>TP1: Me comunique con mis compañeros de equipo sobre cada implementación realizada, asegurando la coherencia y la integración sin problemas entre las diferentes secciones del proyecto.</p> <p>TB2: Participé en sesiones con el equipo para definir los endpoints necesarios y los métodos CRUD que íbamos a implementar, siguiendo una planificación para el desarrollo.</p> <p>TF1: Implementé los servicios definidos, teniendo claro los endpoints y las operaciones CRUD, garantizando así que se cumplieran las necesidades del proyecto.</p> | <p>TB1: La colaboración efectiva entre los integrantes, permitió al grupo definir claramente los requisitos del sistema y asegurarse de que todas las perspectivas fueran consideradas, lo que resultó en un producto final más robusto y bien diseñado.</p> <p>TP1: La organización y coordinación mediante reuniones semanales y el uso de herramientas ayudaron al grupo a mantenerse enfocado, cumplir con los plazos establecidos y mejorar la gestión del proyecto en general.</p> <p>TB2: Las sesiones de revisión y retrospectivas regulares facilitaron la identificación de áreas de mejora y la implementación de cambios necesarios, fomentando un entorno de trabajo donde la mejora continua fue una prioridad compartida por todos los miembros del equipo.</p> <p>TF1: La integración de soluciones técnicas y de diseño, y el enfoque en cumplir con los estándares de calidad, demostraron que el grupo pudo trabajar con eficacia, eficiencia y objetividad, logrando así los objetivos del proyecto y proporcionando una solución de ingeniería de software exitosa.</p> |
| Conoce al menos un sector empresarial o domínio de aplicación de soluciones de software. | <p>Altamirano Saenz, Jorge Armando</p> <p>TB1: Tuve participación en el desarrollo de una plataforma donde las automotrices pudieran tener bien administrados sus inventarios y ventas.</p> <p>TP1: Fui parte del desarrollo de una plataforma que ayudaba a los clientes con vehículos, en tener un seguimiento de los mantenimientos que le corresponden a su vehículo registrado dentro de la plataforma.</p> <p>TB2: Contribuir con el equipo para el desarrollo una plataforma que ayude a administrar los vehículos de los clientes que van a una automotriz y como estos administrar sus reparaciones que le hacen a sus vehículos.</p> <p>TF1: Participé en el desarrollo de la aplicación backend, usando buenas prácticas de programación y DDD, esto ayudó a que el proyecto esté mejor estructurado, además que en el transcurso de este pues fui adquiriendo mayor información de cómo son los sistemas de automotrices más complejos.</p> <p>De la Piedra Quintanilla, Erwin Miquel</p> <p>TB1: Participé en el desarrollo de un sistema de gestión de vehículos para una empresa automotriz, donde trabajé en la implementación de funcionalidades para el seguimiento en tiempo real de vehículos y la programación de mantenimientos preventivos. Esta experiencia me permitió comprender la importancia de la eficiencia operativa y la optimización del uso de vehículos en el sector.</p> <p>TP1: Cree una plataforma para la gestión de inventarios y ventas. Esto me ayudó a entender cómo las automotrices manejan su stock de vehículos, la relación con los clientes y las estrategias de ventas.</p> <p>TB2: Contribuí al desarrollo de una aplicación para la monitorización de la cadena de producción. Esta experiencia me dio una visión profunda de los procesos de manufactura en la industria automotriz y la importancia de la integración de sistemas para asegurar la calidad y eficiencia.</p> <p>TF1: Lideré el desarrollo de una aplicación de conectividad para vehículos en una empresa automotriz, permitiendo a los conductores monitorear el rendimiento de sus vehículos, recibir alertas de mantenimiento y acceder a servicios de asistencia en carretera en tiempo real. Esta solución mejoró significativamente la experiencia del usuario y fortaleció la lealtad del cliente al ofrecer un valor añadido a los propietarios de vehículos.</p> <p>Guimaraes Escalante, Carlos Eduardo</p> <p>TB1: Participé en las primeras implementaciones del proyecto, específicamente en el desarrollo de las principales funcionalidades de inventario y ventas.</p> <p>TP1: Fui parte de la implementación de un soporte para los clientes que tuvieran alguna duda en la plataforma, así como los planes de pago a los cuales el cliente podría acceder.</p> <p>TB2: Participé en la corrección de algunos errores que habían, así como la implementación de notificaciones para los usuarios en la parte del backend.</p> <p>TF1: Fui parte del desarrollo de la aplicación backend, y frontend, haciendo uso siempre de DDD para mantener el proyecto organizado y estructurado de forma correcta, además de que adquirir práctica sobre lo aprendido.</p> <p>Gutierrez Zumaeta, Manuel Alonso</p> <p>TB1: Tuve participación en el desarrollo de una plataforma donde las automotrices pudieran tener bien administrados sus inventarios y ventas.</p> <p>TP1: Fui parte del desarrollo de una plataforma que ayudaba a los clientes con vehículos, en tener un seguimiento de los mantenimientos que le corresponden a su vehículo registrado dentro de la plataforma.</p> <p>TB2: Contribuir con el equipo para el desarrollo una plataforma que ayude a administrar los vehículos de los clientes que van a una automotriz y como estos administrar sus reparaciones que le hacen a sus vehículos.</p> <p>TF1: Participé en el desarrollo de la aplicación backend, usando buenas prácticas de programación y DDD, esto ayudó a que el proyecto esté mejor estructurado, además que en el transcurso de este pues fui adquiriendo mayor información de cómo son los sistemas de automotrices más complejos.</p> <p>Montes Figueroa, Juan Eduardo</p> <p>TB1: Desarrollé una plataforma para gestionar los inventarios y ventas de automotrices, mejorando la eficiencia y organización del proceso.</p> <p>TP1: Participé en la creación de una aplicación que permite a los propietarios de vehículos realizar un seguimiento de los servicios de mantenimiento programados, facilitando la gestión y el cumplimiento de estos servicios.</p> <p>TB2: Colaboré en el desarrollo de una plataforma que permite a los clientes de talleres automotrices gestionar sus vehículos y llevar un registro detallado de las reparaciones realizadas.</p> <p>TF1: Contribuí al desarrollo del backend de la aplicación, aplicando buenas prácticas de programación y principios de DDD, lo que resultó en una estructura de proyecto más sólida y me permitió adquirir un conocimiento más profundo sobre los sistemas complejos de la industria automotriz.</p> | <p>TB1: La implementación del sistema de gestión de vehículos resultó en una mejora significativa de la eficiencia operativa, optimizando el uso de vehículos y reduciendo los costos de mantenimiento preventivo, lo que benefició tanto a la empresa automotriz como a sus clientes.</p> <p>TP1: La plataforma de gestión de inventarios y ventas facilitó un manejo más eficiente del stock de vehículos y mejoró la relación con los clientes. Esto condujo a un aumento en las ventas y una mayor satisfacción del cliente, fortaleciendo la posición competitiva de los concesionarios.</p> <p>TB2: La aplicación de monitorización de la cadena de producción mejoró la integración de los sistemas de manufactura, asegurando procesos más eficientes y una mayor calidad en la producción de automóviles. Esta herramienta permitió identificar y resolver problemas rápidamente, optimizando el flujo de trabajo.</p> <p>TF1: El sistema de diagnóstico y mantenimiento para vehículos aumentó la precisión de los diagnósticos y la eficiencia en la gestión de reparaciones y repuestos. Esto no solo benefició a los talleres de reparación al mejorar su capacidad de servicio, sino que también incrementó la satisfacción de los clientes al recibir un mantenimiento más rápido y efectivo.</p> |
...
<p>Para elaborar nuestro Product Backlog hemos utilizado la secuencia de Fibonacci (1,2,3,5,8).
Aplicamos esto con el objetivo de evaluar la complejidad de las tareas.
</p>

<p><strong>Historia de usuario base:</strong><br></p>
<p>Como cliente que cuenta con un vehículo, quiero poder registrar los datos de mi vehículo en la aplicación. (Posee 8 puntos de historia)</p>
...
Para comprobar el correcto deploy se accedio a:
[https://github.com/AplicacionesWeb-DriveSmart/frontend-carhelp/settings/pages](https://github.com/AplicacionesWeb-DriveSmart/frontend-carhelp/settings/pages)
...
Exposición about the product: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210364_upc_edu_pe/Ed70YBaIaHZLqp34vbnO5qoBwNsnElzds1FAFt2Gr5rt6A?e=RLzI1g&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D

Exposición about the team: https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210364_upc_edu_pe/EQRt_MPrknFPu-Ca_YcJ-T8BCTKjUTmv5Zz8VG2clJL_NQ?e=2aj8IH&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D
